...
\begin{notebox}
  ...
  Les données présentées s'appuient sur les documents financiers officiels du
  projet (Bilan actif/passif, Tableau des flux de trésorerie, Compte de résultat).
\end{notebox}
...
\begin{center}
  \rule{8cm}{0.4pt}\\[4pt]
  {\small\itshape Fin du Plan Financier Prévisionnel — Baligh+}\\[2pt]
  {\small Université Akli Mohand Oulhadj de Bouira — 2024/2025}
\end{center}
