% ============================================================
%  Mémoire de Master — Balligh+
%  Plateforme Intelligente de Signalement Urbain
%  Université Akli Mohand Oulhadj de Bouira — 2024/2025
% ============================================================
...
% \definecolor{accent}{RGB}{0,130,100}
...
% \pagestyle{fancy}
% \fancyhf{}
% \fancyhead[L]{\small\textcolor{primary}{Balligh+ — Signalement Urbain}}
% \fancyhead[R]{\small\textcolor{primary}{\leftmark}}
% \fancyfoot[C]{\thepage}
...
% \newcommand{\thdcell}[1]{\textbf{\textcolor{white}{#1}}}
...
\usepackage{xcolor}
\definecolor{primary}{RGB}{0, 100, 70}        % Vert émeraude — couleur principale
...
\definecolor{lightbg}{RGB}{248, 248, 244}      % Fond ivoire très doux
...
encadreur, \textbf{Mr DJOUABRI Abdrazak}, pour sa disponibilité, ses précieux
conseils et son accompagnement rigoureux tout au long de l'élaboration de ce
mémoire.
...
de la formation dispensée au cours de nos années d'études.

Notre gratitude va aussi aux membres du jury pour l'attention portée à
l'évaluation de ce travail.

Enfin, nous exprimons notre profonde reconnaissance à nos familles et proches
pour leur soutien moral indéfectible, sans lequel ce projet n'aurait pu voir le
jour.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{|X|X|}
    \hline
    \cellcolor{primary!80}\textbf{\textcolor{white}{FORCES}}        & \cellcolor{accent!80}\textbf{\textcolor{white}{FAIBLESSES}} \\
    \hline
    ...
    \end{itemize}                                             \\
    \hline
    \cellcolor{blue!60}\textbf{\textcolor{white}{OPPORTUNITÉS}}     & \cellcolor{red!60}\textbf{\textcolor{white}{MENACES}}       \\
    \hline
    \begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt]
