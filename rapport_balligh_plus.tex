...
%   {\normalsize\itshape
%   Nous dédions ce travail à nos familles,\\[0.3cm]
%   à nos parents qui nous ont soutenus tout au long de ce parcours,\\[0.3cm]
%   à nos enseignants qui nous ont guidés avec bienveillance,\\[0.3cm]
%   ainsi qu'à tous ceux qui croient en l'avenir numérique de l'Algérie.\\[1cm]
%   \textit{« Le savoir est une lumière que nul ne peut éteindre. »}
%   }\\[1cm]
%   \rule{0.4\linewidth}{0.4pt}
% \end{center}
% \newpage
% =========================
% Dédicace de RAHAL Lyes
% =========================
...
%   \toprule
%   \rowcolor{primary}
%   \thdcell{Abréviation} & \thdcell{Signification}                                                    \\
%   \midrule
...
\begin{arabtext}
t^shd Almdn Alj_z'yrp t.hwlt Emy_qp, tqdwhA 'jyl mt_s_lp bAlEAlm Alrqmy wdwlp
tsEY 'ilY Alt.hdyt. wfy x.d_m h_d_A Alt.hwl Al^sAml Al_dy y.tAl tdryjA~ kl q_t_AEAt
Al.hyAp AlEAmp, ybqY .hlqp 'AsAsyp mg_fwlp fy 'gbl Al'.hyAn{:} Alrb_t AlmbA^sr byn
Almw_t_n wbldyth.

fy h_d_A Als_yyAq wuld_t fkrp blg+  mstw.hApN mn AlfiEl AlErby bl-g bmEnY Al'ixbAr
wAl'iy_sAl  mn_s_p rqmyp mtkAmlp mxs_s_p ll'iblAg Alt^sArky En Al'AE_tAl Al.hd_yryp.
Al.hfr fy Al_t_rqAt, wAE_tAl Al'id_A'p AlEmwmyp, wtsrbt Almy_Ah, wAlm_tAr.h AlE^s_w'yyp
llnfAyAt{:} '^ skAlyAt ywmyp t_z_l dwn .hlwl lftrt _twylt bsbb gyAb qnAp twA_sl fE_Alp.

ystEr.d h_d_A Al_md_krp msAr Al'injAz bkAmh{:} mn t^sx-y_s Alm^sklp wt.hlyl Als_wq,
mrwr_AN bAlt_s_mym AlmErmAry wt_twyr AlnmwD_j Al'Awly Alwz_yfy, ws_wl_AN 'ilY Als_trAtyjyp
Alt_jAryp wruyp Alt_t_wwr ElY Almd_y AlbEyd. whw _tmrp jhd jmAEy yjmE Al_s_rAmp
Al'AkAdymyp wAl.hsAsyp tjAh AlwAqE Alm.hly wAl_t_mw.h Alryl Ady.

n'm_l 'An ys_hm h_d_A AlEml, wlw b^skl mtwA.d_E, fy Altkyr AlJmAEy .hwl dwr
Alt_knwlwjyA Alrqmyp fy .hwkmp Almjtm_EAt Alm.hlyp Alj_z'yrp, w'An y^sj_E _tlAb_AN
'Axryn ElY Al'AnxrA_t fy m^Ary_E _dAt '_tr trAby mlmws.
